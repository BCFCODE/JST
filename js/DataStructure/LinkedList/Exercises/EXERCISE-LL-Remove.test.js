  ...
  describe(`remove(index)`, () => {
    ...
    describe('After removing first element: remove(0)\n\tlet myLinkedList = new LinkedList(1);\n\tmyLinkedList.push(2);\n\tmyLinkedList.push(3);\n\tmyLinkedList.push(4);\n\tmyLinkedList.push(5);\n\tconst removeValue = myLinkedList.remove(0)', () => {
      ...
      const tests = [
        ...
        ['removeValue.value', removeValue.value, 'toBe', 1],
        ['removeValue.next', removeValue.next, 'toBeNull', null],
        ['typeof removeValue', removeValue.next, 'toBeTypeOf', 'object'],
      ]

      runTests(tests)
    })

    describe('After removing last element: remove(4)\n\tlet myLinkedList = new LinkedList(1);\n\tmyLinkedList.push(2);\n\tmyLinkedList.push(3);\n\tmyLinkedList.push(4);\n\tmyLinkedList.push(5);\n\tconst removeValue = myLinkedList.remove(4)', () => {
      let myLinkedList = new LinkedList(1);
      myLinkedList.push(2);
      myLinkedList.push(3);
      myLinkedList.push(4);
      ...
      const tests = [
        ...
        ['myLinkedList.tail.next', myLinkedList.tail.next, 'toBeNull', null],
        ['myLinkedList.length', myLinkedList.length, 'toEqual', 4],
        ['removeValue.value', removeValue.value, 'toBe', 5],
        ['removeValue.next', removeValue.next, 'toBeNull', null],
        ['typeof removeValue', removeValue.next, 'toBeTypeOf', 'object'],
      ]
    ...
    describe('After removing middle element: remove(2)\n\tlet myLinkedList = new LinkedList(1);\n\tmyLinkedList.push(2);\n\tmyLinkedList.push(3);\n\tmyLinkedList.push(4);\n\tmyLinkedList.push(5);\n\tconst removeValue = myLinkedList.remove(2)', () => {
      ...
      const tests = [
        ...
        ['myLinkedList.tail.next', myLinkedList.tail.next, 'toBeNull', null],
        ['myLinkedList.length', myLinkedList.length, 'toEqual', 4],
        ['removeValue.value', removeValue.value, 'toBe', 3],
        ['removeValue.next', removeValue.next, 'toBeNull', null],
        ['typeof removeValue', removeValue.next, 'toBeTypeOf', 'object'],
      ]
